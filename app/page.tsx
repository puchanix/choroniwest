    ...
    <main>
      ...
      <section className="manifesto shell">
        <div className="manifesto-card">
          ...
          <Link className="button ink" href="/apply">Begin · about 10–15 minutes</Link>
        </div>
      ...
      <section className="about shell" id="about">
        ...
        <div className="about-grid">
          <div>
            <h2>Small grants.<br/>Serious intent.</h2>
          </div>
          <div className="prose">
            ...
            <p>The grant is intentionally flexible. Applicants choose the project, shape the budget, and request the amount they believe the work requires. A grant may cover <strong>up to 100% of a project’s costs.</strong> Choroni West may choose to fund a proposal in full or in part.</p>
          </div>
        </div>
      ...
      <footer className="shell footer"><strong>{grantConfig.name}</strong><span>For emerging artists & creative producers</span></footer>
    </main>
  );
}
